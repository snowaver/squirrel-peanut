...
public  class  ContactGroupAdapter   extends    BaseExpandableListAdapter
{
	...
	public  View  getChildView( int  groupPosition,int  childPosition,boolean  isLastChild,View  convertView,ViewGroup  parent )
	{
		...
		ObjectUtils.cast(convertView.findViewById(R.id.nickname),TextView.class).setText( contact.getRemark() );
	...
	{
		return  ContactRepository.DAO.getContactGroups().get(Ordering.natural().sortedCopy(new  LinkedList<String>(ContactRepository.DAO.getContactGroups().keySet())).get(groupPosition)).get( childPosition );
	}

	public  int  getGroupCount()
	{
		return  ContactRepository.DAO.getContactGroups().keySet().size();
	}

	public  String  getGroup(      int  groupPosition )
	{
		return  Ordering.natural().sortedCopy(new  LinkedList<String>(ContactRepository.DAO.getContactGroups().keySet())).get( groupPosition );
	}

	public  int  getChildrenCount( int  groupPosition )
	{
		return  ContactRepository.DAO.getContactGroups().get(Ordering.natural().sortedCopy(new  LinkedList<String>(ContactRepository.DAO.getContactGroups().keySet())).get(groupPosition)).size();
	}
}