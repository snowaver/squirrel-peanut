...
public  class ContactProfileActivity extends  AbstractPacketListenerActivity  implements  View.OnClickListener , SmoothCheckBox.OnCheckedChangeListener , DialogInterface.OnClickListener , KeyboardVisibilityEventListener
{
						...
						(
							new  AbstractRetrofit2Callback<Void>( this,ExtviewsAdapter.adapter(new  UIProgressDialog.WeBoBuilder(this).setTextSize(18).setMessage(R.string.waiting).setCanceledOnTouchOutside(false).create(),ResourcesCompat.getFont(this,R.font.droid_sans_mono)).setWidth(DensityUtils.px(this,220)).setHeight(DensityUtils.px(this,150)) )
							{
								...
								public  void  onResponse( Call<Void>  call , Response<Void>  response )
								{
									...
									{
										PacketEventDispatcher.sent( new  SubscribeAckPacket(user.getLong("ID"),SubscribeAckPacket.ACK_ACCEPT,new  HashMap<String,Object>().addEntry("GROUP",ObjectUtils.cast(ContactProfileActivity.this.findViewById(R.id.group),StyleableEditView.class).getText().toString().trim()).addEntry("USERNAME",user.get("USERNAME")).addEntry("NICKNAME",user.getString("NICKNAME"))),TransportState.SENT );

										ObjectUtils.cast(ContactProfileActivity.this.findViewById(R.id.subscribe_button),Button.class).setText( getString( R.string.message ) );

										showSneakerWindow( Sneaker.with(ContactProfileActivity.this),com.irozon.sneaker.R.drawable.ic_success,   R.string.subscribe_contact_added,R.color.white,R.color.limegreen );
									}
									else
									{
										showSneakerWindow( Sneaker.with(ContactProfileActivity.this),com.irozon.sneaker.R.drawable.ic_error,R.string.network_or_internal_server_error,  R.color.white,R.color.red );
									}
								}
							}
						);
						...
						(
							new  AbstractRetrofit2Callback<Void>( this,ExtviewsAdapter.adapter(new  UIProgressDialog.WeBoBuilder(this).setTextSize(18).setMessage(R.string.waiting).setCanceledOnTouchOutside(false).create(),ResourcesCompat.getFont(this,R.font.droid_sans_mono)).setWidth(DensityUtils.px(this,220)).setHeight(DensityUtils.px(this,150)) )
							{
								...
								public  void  onResponse( Call<Void>  call , Response<Void>  response )
								{
									...
									if( response.code()==200)
									{
										PacketEventDispatcher.sent(new  SubscribePacket(user.getLong("ID"),new  HashMap<String,Object>().addEntry("REMARK",ObjectUtils.cast(ContactProfileActivity.this.findViewById(R.id.remark),StyleableEditView.class).getText().toString().trim()).addEntry("USERNAME",user.getString("USERNAME")).addEntry("NICKNAME",user.getString("NICKNAME")).addEntry("GROUP",ObjectUtils.cast(ContactProfileActivity.this.findViewById(R.id.group),StyleableEditView.class).getText().toString().trim())),TransportState.SENT );

										ObjectUtils.cast(ContactProfileActivity.this.findViewById(R.id.subscribe_button),Button.class).setBackgroundColor(ContactProfileActivity.super.getResources().getColor(R.color.gainsboro) );

										showSneakerWindow( Sneaker.with(ContactProfileActivity.this),com.irozon.sneaker.R.drawable.ic_success    ,R.string.subscribe_request_sent,R.color.white,R.color.limegreen );
									}
									else
									{
										showSneakerWindow( Sneaker.with(ContactProfileActivity.this),com.irozon.sneaker.R.drawable.ic_error,R.string.network_or_internal_server_error,  R.color.white,R.color.red );
